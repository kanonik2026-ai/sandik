...
import { Sparkles, Backpack, X, Check } from 'lucide-react';
import { useGame } from '../context/GameContext';
import { getRarityColor, getRarityLabel } from '../services/dataDragon';

export const ChestOpenModal: React.FC = () => {
  const { activeChestModal, closeChestModal, claimSkin, disenchantSkin } = useGame();
    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/90 backdrop-blur-md">
        ...
        >
          ...
          {/* Center Card: High Res Splash Art from Riot Data Dragon */}
          <div className="p-6 flex flex-col items-center text-center">
            <div className="relative w-full aspect-[16/9] max-w-md rounded-sm overflow-hidden border-2 border-[#c8aa6e]/60 shadow-[0_0_30px_rgba(0,0,0,0.8)] group mb-4">
              <img
              ...
              <div className="absolute bottom-3 left-4 right-4 text-left">
                ...
                <h3 className="text-lg font-bold tracking-wide text-white drop-shadow-md">
